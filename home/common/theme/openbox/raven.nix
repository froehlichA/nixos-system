...
in {
    home.file.".themes/bonzo/openbox-3/themerc".source = builtins.toFile "themerc" ''
        ...
        window.active.button.pressed.image.color: ${colors.color1}
        ...
        window.active.button.toggled.pressed.image.color: ${colors.color1}
        window.active.button.toggled.hover.image.color: #afb8c5
        window.inactive.button.unpressed.image.color: #1F2328
        window.inactive.button.pressed.image.color: ${colors.color1}
        ...
        window.inactive.button.toggled.pressed.image.color: ${colors.color1}
        ...
        menu.items.active.bg.color: ${colors.color1}
        ...
        osd.hilight.bg.color: ${colors.color1}
